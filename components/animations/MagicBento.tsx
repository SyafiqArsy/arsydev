...
const DEFAULT_GLOW_COLOR = "91, 141, 239";
...
const DEFAULT_CARDS: BentoCardData[] = [
  { color: "#0b1120", title: "Frontend Development", description: "React, Next.js, TypeScript", label: "💻" },
  { color: "#0b1120", title: "UI/UX Design", description: "Figma, Design Systems", label: "🎨" },
  { color: "#0b1120", title: "Motion Design", description: "GSAP, Framer Motion", label: "✨" },
  { color: "#0b1120", title: "Creative Coding", description: "Three.js, Canvas API", label: "🧪" },
  { color: "#0b1120", title: "Tools & Workflow", description: "Git, CI/CD, VS Code", label: "⚙️" },
  { color: "#0b1120", title: "Backend Basics", description: "Node.js, REST APIs", label: "🔧" },
];
...
export default function MagicBento({
  ...
  return (
    <>
      ...
      <div className={`card-grid bento-section${className ? ` ${className}` : ""}`} ref={gridRef}>
