...
export default function AccordionGallery({
  ...
  const panelRefs = useRef<(HTMLDivElement | HTMLAnchorElement)[]>([]);
        ...
        return (
          <Tag
            ...
            ref={(el: HTMLDivElement | HTMLAnchorElement | null) => {
              panelRefs.current[i] = el as HTMLDivElement | HTMLAnchorElement;
            }}
          ...
          >
            <span className="ag-panel__frame">
              <span
                ...
                ref={(el) => { mediaRefs.current[i] = el as HTMLSpanElement; }}
              >
            ...
            {showLabels && (
              <span className="ag-panel__label" aria-hidden="true">
                <span
                  ...
                  ref={(el) => { barRefs.current[i] = el as HTMLSpanElement; }}
                />
                <span
                  className="ag-panel__text"
                  ref={(el) => { textRefs.current[i] = el as HTMLSpanElement; }}
                >
                  {item.label}
                </span>
              </span>
